...
object CommonAttrDefine {
    ...
    val MIN_WIDTH_N: NullableFloatAttrDefine = NullableFloatAttrDefine(name = "minWidth")
    val MAX_WIDTH_N: NullableFloatAttrDefine = NullableFloatAttrDefine(name = "maxWidth")
    val MIN_HEIGHT_N: NullableFloatAttrDefine = NullableFloatAttrDefine(name = "minHeight")
    val MAX_HEIGHT_N: NullableFloatAttrDefine = NullableFloatAttrDefine(name = "maxHeight")
